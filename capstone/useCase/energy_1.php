...
<div>
<p> Specific Energy Assessment for X Sub-capability </p>
<form method="post">
    <label><input type="radio" name="options" value="hbs" /> 1</label>
    <label><input type="radio" name="options" value="bs" /> 2 </label>
    <label><input type="radio" name="options" value="pvr" /> 3</label>
    <label><input type="radio" name="options" value="epc" /> 4 </label>
