...
<h1 class="display-5"> Level 3 Use-Case Assessment </h1>

<?php
$value_to_page = array(
    "hbs" => 'useCase/digIdentity.php',
...
<div>
<p>What sub-capability do you want to use under Digital Ownership?  </p>
<form method="post">
    <label><input type="radio" name="options" value="hbs" /> Digital Identity Applications </label>
    <label><input type="radio" name="options" value="bs" /> Smart Contracts </label>
    <label><input type="radio" name="options" value="pvr" /> NFTs </label>
    <label><input type="radio" name="options" value="epc" /> Loyalty Programs </label>
